    ...
    <div className='about-section-container'>
        ...
        <div className='about-section-text-container'>
            ...
            <p className='primary-text'>
                Lorem ipsum dolor hryu amet consectetur jgwfhisicing elit. Aspernatur fugit labore sequi! Dicta harum placeat quam obcaecati deleniti vitae esse, voluptatem facere!
            </p>
            <p className='primary-text'>
